      ...
      <div className="contact-layout">
        <div className="contact-info">
          ...
          <div className="social-links">
            <a href="https://www.facebook.com/TSG.IITKharagpur" className="social-link" target="_blank" rel="noreferrer">
            ...
            <a href="https://github.com/tsg-iitkgp" className="social-link" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.youtube.com/channel/UCuTNELMlkNfJxAQ2vGJIe5Q" className="social-link" target="_blank" rel="noreferrer">
            ...
            <a href="https://www.instagram.com/tsg.iitkharagpur/?hl=en" className="social-link" target="_blank" rel="noreferrer">
