      ...
      <div className={Styles.footerContainer}>
        <div className={Styles.tsgContainer}>
          ...
          <div className={Styles.iconsContainer}>
            <a target="_blank" href="https://www.facebook.com/TSG.IITKharagpur" rel="noreferrer">
              <FaFacebook />
            </a>
            <a target="_blank" href="https://github.com/tsg-iitkgp" rel="noreferrer">
              <FaGithub />
            </a>
            <a
              target="_blank"
